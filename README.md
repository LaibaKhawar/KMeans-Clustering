...
An educational implementation and experiment exploring **kmeans clustering**. This repository preserves the original work while adding the structure and documentation needed to understand, reproduce, and extend it.
...
- `labtask5_Datamining_1752.ipynb`
- `lab5.ipynb`
...
```bash
git clone https://github.com/LaibaKhawar/KMeans-Clustering.git
